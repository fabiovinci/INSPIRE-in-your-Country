<h1 class="title" id="page-title">INSPIRE in your Country</h1>
  ...
  <div class="view view-Mappas view-id-Mappas view-display-id-page_5 view-dom-id-578ae6464ac59559efc04b2ca8b7d03a">
       ...
       <p>
	<img alt="" src="https://inspire.ec.europa.eu/sites/default/files/notext_icons/notxt_21_INSPIRE_in_your_country_result.png" style="width: 158px; height: 131px; float: right;" />In this section you can find information about INSPIRE in the countries implementing INSPIRE.
</p>

<span style="color: rgb(34, 34, 34); font-family: 'Lucida Grande', 'DejaVu Sans', 'Bitstream Vera Sans', Verdana, Arial, sans-serif; font-size: 13px; line-height: 18px; background-color: rgb(255, 255, 255);">Click here to <a href="https://inspire.ec.europa.eu/moinitoring_geo_coleaf">view the Map Mode</a></span>

 <br /><h3>Europe</h3>
<img src="https://inspire.ec.europa.eu/sites/default/files/255px-Flag_of_Europe.svg_.png" style="width:8%;&quot;" /><p>
<a href="https://inspire.ec.europa.eu/documents/summary-report-status-implementation-inspire-directive-eu">  
Summary Report on Status of implementation of the INSPIRE Directive in EU </a></p>
    </div>
...
<table class="views-view-grid cols-3">
  ...
  <div class="views-field views-field-field-country">        <div class="field-content"><a href="/INSPIRE-in-your-Country/IT/README.md" class="klas_IT"><img class="countryicon iconset-gosquared_shiny_small countrycode-it" src="https://inspire.ec.europa.eu/sites/all/modules/contrib/countryicons_gosquared/shiny-small/it.png" alt="IT" title="Italy" /> Italy</a></div>  </div>          </td>
                  <td  class="col-3 col-last">
